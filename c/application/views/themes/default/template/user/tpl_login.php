...
<div id="main-container" class="wrap-container container clearfix">
    <div class="main-content full-width controller-site action-login">
        ...
        <div class="login-signup-container clearfix">
            <h1 class="gutter-bottom clearfix align-center"> Đăng nhập
                <aside class="clearfix">Chưa có tài khoản?
                    <a class="call-to-action" href="user/signup">Đăng ký</a>
                </aside>
            </h1>
                    ...
                    <div class="fullPage loginDiv clearfix">
                        <div>
                            ...
                            <div class="gutter-top align-center" data-hook="partial-facebook-button" style="display: none;">
                                <a class="action-social-login tall button social-button facebook" rel="nofollow" href="<?= $facebookLoginUrl; ?>">Đăng nhập bằng Facebook</a>
                                <div class="fb-facepile-container last clearfix">
                        ...
                        <div class="col-xs-12 col-sm-offset-3 col-sm-6 col-md-4 col-md-offset-4 no-padding">
                            <div class=" signin clearfix" >
                                ...
                                <div class="clearfix gutter-bottom">
                                    ...
                                    <div class="col-xs-6 no-padding text-right">
                                        <div class="clear clearfix">
                                            <a class="forgotPassword gutter-bottom clear" rel="nofollow" href="#">Quên mật khẩu?</a>
                                        </div>
                                    </div>
                                ...
                                <div class="clearfix">
                                    <input tabindex="4" class="call-to-action tall gutter-bottom btn-inverted" type="submit" name="yt0" value="Đăng nhập" />
